import numpy as np
from evaluation.knapsack_implementation import knapsack

def generate_summary(all_shot_bound, all_scores, all_nframes, all_positions, percentage=0.15): 
    ...
    for video_idx in range(len(all_scores)):
        ...
        final_max_length = int((shot[1] + 1)*percentage)
